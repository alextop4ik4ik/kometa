...
local hivetab = ui:Category("Улей")
local misctab = ui:Category("Главное")
local extrtab = ui:Category("Екстра")
local Configs_Category = ui:Category("Конфиг")
local setttab = ui:Category("Настройки")
